    ...
    (0, _createClass3.default)(Gren, [{
                                            ...
                                            while (1) {
                                                switch (_context10.prev = _context10.next) {
                                                    case 0:
                                                        ...
                                                        _context10.next = 4;
                                                        return _this6._getCommitsBetweenTwo(since, until);
        ...
        value: function _createReleaseRanges(releaseDates) {
            ...
            for (var i = 0; i < sortedReleaseDates.length - 1; i++) {
                ...
                var until = new Date(new Date(sortedReleaseDates[i + 1].date).getTime() + 1000).toISOString().replace(/\.000Z$/, 'Z');
